...
<template>
  <div class="p-8">
    <h1 class="mb-4 font-bold text-2xl">{{ cityStore.step.title }}</h1>
    <article class="prose max-w-none lg:prose-xl prose-invert" v-html="markdown.render(cityStore.step.content)"></article>
